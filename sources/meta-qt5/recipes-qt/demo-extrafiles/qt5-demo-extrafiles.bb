DESCRIPTION = "Extra files for edm-image-qt5"
LICENSE = "LGPLv2"
S="${WORKDIR}"
LIC_FILES_CHKSUM = "file://LICENSE;md5=88355dc91a186cc816d9f64757793895"

SRC_URI += "file://browser.desktop \
            file://browser.png \
            file://cinematicexperience.desktop \
            ...
            file://qt5launchdemo.desktop \
            file://qt5launchdemo.png \
            ...
            file://qtledcombo.png \
            file://qtpatientcare.desktop \
            file://qtpatientcare.png \
            ...
            file://videowidget.desktop \
            file://videowidget.png \
...
do_install () {
    ...
    install -m 0644 ${WORKDIR}/browser.png ${D}/${datadir}/pixmaps
    install -m 0644 ${WORKDIR}/browser.desktop ${D}/${datadir}/applications
    ...
    install -m 0644 ${WORKDIR}/qt5launchdemo.png ${D}/${datadir}/pixmaps
    install -m 0644 ${WORKDIR}/qt5launchdemo.desktop ${D}/${datadir}/applications
    ...
    install -m 0644 ${WORKDIR}/qtpatientcare.png ${D}/${datadir}/pixmaps
    install -m 0644 ${WORKDIR}/qtpatientcare.desktop ${D}/${datadir}/applications
    ...
    install -m 0644 ${WORKDIR}/videowidget.png ${D}/${datadir}/pixmaps
    install -m 0644 ${WORKDIR}/videowidget.desktop ${D}/${datadir}/applications 
