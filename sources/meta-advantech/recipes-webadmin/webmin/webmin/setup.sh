...
# Add Advantech patch
ver=`cat "$wadir/version"`+Advantech_patch
echo $ver > $wadir/version
...
echo $perl_runtime > $config_dir/perl-path
...
echo "nrdustwsn > /tmp/nrdustwsn" >>$config_dir/start
